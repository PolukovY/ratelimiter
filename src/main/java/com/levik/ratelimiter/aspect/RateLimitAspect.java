package com.levik.ratelimiter.aspect;

import com.levik.ratelimiter.annotation.RateLimitProtection;
import com.levik.ratelimiter.exception.RateLimitException;
...
public class RateLimitAspect {
     ...
     */
    @Before("@annotation(com.levik.ratelimiter.annotation.RateLimitProtection)")
    public void rateLimit() {
        final ServletRequestAttributes requestAttributes = (ServletRequestAttributes) RequestContextHolder.currentRequestAttributes();
        String key = requestAttributes.getRequest().getHeader(X_FORWARDED_FOR);
        final long currentTime = System.currentTimeMillis();
        log.info("Request key {} currentTime {}", key, currentTime);
